...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $db->prepare("INSERT INTO main_stage_reservations (name, email, event_description, request_time) VALUES (?, ?, ?, NOW())");
    $stmt->execute([$name, $email, $event_description]);
    ...
    $mail->Subject = "Main Stage Reservation Received";
    $mail->Body = "Thank you for your reservation for the main stage. We have received the following information:\n\n";
...
<head>
    ...
    <title>Main Stage Reservation - Kean University eSports Arena</title>
